...
class YOLO(nn.Module):
    ...
    def create_modules(self):
        ...
        # 1st Layer - Conv1, ReLU1, MaxPool1
        ...
        # 2nd Layer - Conv2, ReLU2, MaxPool2
        ...
        # 3rd Layer - Conv3, ReLU3, MaxPool3
        ...
        # 4th Layer - Conv4, ReLU4, MaxPool4
        ...
        # 5th Layer - Conv5, ReLU5, MaxPool5
        ...
        # 6th Layer - Conv6, ReLU6, MaxPool6
        ...
        # 11th Layer - Fully Connected 1 (FC1)
        modules.add_module("FC1", nn.Linear(1024 * 7 * 7, 256))

        # 12th Layer - Fully Connected 2 (FC2)
        modules.add_module("FC2", nn.Linear(256, 256))

        # 13th Layer - Fully Connected Output
